...
CREATE TABLE `analisi` (
  ...
  CONSTRAINT `analisi_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`id`) ON UPDATE CASCADE
...
CREATE TABLE `fotoanalisi` (
  ...
  PRIMARY KEY (`id`),
  KEY `idAnalisis` (`idAnalisis`),
  CONSTRAINT `fotoanalisi_ibfk_1` FOREIGN KEY (`idAnalisis`) REFERENCES `analisi` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `fotoguia` (
  ...
  PRIMARY KEY (`id`),
  KEY `idGuia` (`idGuia`),
  CONSTRAINT `fotoguia_ibfk_1` FOREIGN KEY (`idGuia`) REFERENCES `guia` (`id`) ON UPDATE CASCADE
...
INSERT INTO `fotoguia` VALUES (1,'desconocido.txt',1),(2,'desconocido.txt',2);
...
CREATE TABLE `fotojuego` (
  ...
  PRIMARY KEY (`id`),
  KEY `idJuego` (`idJuego`),
  CONSTRAINT `fotojuego_ibfk_1` FOREIGN KEY (`idJuego`) REFERENCES `juego` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `guia` (
  ...
  PRIMARY KEY (`id`),
  KEY `idUsuario` (`idUsuario`),
  CONSTRAINT `guia_ibfk_1` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `guia` VALUES (2,'f','f',1);
...
CREATE TABLE `juego` (
  ...
  CONSTRAINT `juego_ibfk_3` FOREIGN KEY (`idUsuario`) REFERENCES `usuario` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `videoanalisi` (
  ...
  PRIMARY KEY (`id`),
  KEY `idAnalisis` (`idAnalisis`),
  CONSTRAINT `videoanalisi_ibfk_1` FOREIGN KEY (`idAnalisis`) REFERENCES `analisi` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `videoguia` (
  ...
  PRIMARY KEY (`id`),
  KEY `idGuia` (`idGuia`),
  CONSTRAINT `videoguia_ibfk_1` FOREIGN KEY (`idGuia`) REFERENCES `guia` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-04-17 16:42:08
