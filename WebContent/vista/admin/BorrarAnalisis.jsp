...
ArrayList<Analisis> listaJuego = (ArrayList<Analisis>) request.getAttribute("listaJuego");
		...
		if (user == null) {
			...
			out.print("<h3>Tu lista de análisis añadidas</h3>");
			out.print("</div>");
			out.print("<div class=\"col\">");
			out.print("<ul class=\"list-group\">");
			if(listaJuego!=null){
			for(Analisis a : listaJuego){
			out.print("<li class=\"list-group-item\">"+a.getTitulo()+" <a href=\"BorradoAnalisis?id="+a.getId()+"\"><button type=\"button\" class=\"btn btn-success ml-5\">Borrar Análisis</button></a></li>");
			}
			}else{
