...
<%
		...
		if (user == null) {
			...
			//----" 2 row"------
			out.print("<form method=\"post\" action=\"EditadoAnalisis\" enctype=\"multipart/form-data\">"); //-----------form----------
...
// 			out.print("</div>");
			...
			out.print("<textarea class=\"form-control\" id=\"Textarea1\" rows=\"3\" name=\"desc\">"+juego.getTexto()+"</textarea>");
			out.print("</div>");
			out.print("</div>");
			out.print("</div>");
