...
<body>
	...
	ArrayList<Usuario> users = (ArrayList<Usuario>) request.getAttribute("users");
		...
		if (user == null) {
			...
			out.print("<a href=\"Registro\"><button type=\"button\" class=\"btn btn-info\">Registrate</button></a>");
			out.print("</div>");
			out.print("<div class=\"col-md-3\">");
			out.print("<a href=\"Login\"><button type=\"button\" class=\"btn btn-info\">Inicia Sesión</button></a>");
			out.print("</div>");
			out.print("</div>");
			out.print("<hr>");
