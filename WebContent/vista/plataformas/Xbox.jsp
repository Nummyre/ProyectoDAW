...
<body>
	...
	ArrayList<PlataformasJuegos> xboxList = (ArrayList<PlataformasJuegos>) request.getAttribute("xboxList");
		...
		if (user == null) {
			...
			out.print("<h3>Juegos de Xbox One</h3>");
			out.print("</div>");
			out.print("</div>");
			...
			out.print("</thead>");
			out.print("<tbody>");
			for(PlataformasJuegos n : xboxList){
			out.print("<tr>");
	...
	%>
		...
		<div class="text-center center-block p-5">
			<a href="https://es-es.facebook.com/" class="fa fa-facebook"></a> <a href="https://twitter.com/compose/tweet?hashtags=FreaksCorner&hashtags=JuegosParaXboxOne"
